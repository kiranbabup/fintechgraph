...
import DialogSelect from "./OpenSelectOptions";
    ...
    return (
        <div style={mainDivStyle}>
            <div>
                ...
                {open && <DialogSelect open={open} handleClose={handleClose} handleDropdownChange={handleDropdownChange} selectedOption={selectedOption} mainOption={mainOption} onViewClick={onViewClick} onCompareClick={onCompareClick}/>}
            </div>
            {
