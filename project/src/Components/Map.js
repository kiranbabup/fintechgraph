                ...
                <fieldset style={fieldsetStyle}>
                    ...
                    <Box style={columnStyle}>
                        <select value={selectedOptionStock1} onChange={(e) => setSelectedOptionStock1(e.target.value)} style={selectStyle}>
                            ...
                            <option value="tri__NIFTY_LARGEMID250_Pcnt_Rank" key="tri__NIFTY_LARGEMID250_Pcnt_Rank">NIFTY LARGEMID 250</option>
                            <option value="tri__NIFTY_MIDSML_400_Pcnt_Rank" key="tri__NIFTY_MIDSML_400_Pcnt_Rank">NIFTY MIDSML 400</option>
                        </select>
                        <LoadingButton loading={isLoadingBroadHeatMap} variant="contained" onClick={() => onBroadHandle()}>Compare All Broad Stocks</LoadingButton>
                    </Box>
                </fieldset>
                <fieldset style={fieldsetStyle}>
                    ...
                    <Box style={columnStyle}>
                        ...
                        <LoadingButton loading={isLoadingStrategyHeatMap} variant="contained" onClick={() => onStrategyHandle()}>Compare All Strategy Stocks</LoadingButton>
                    </Box>
                </fieldset>
                <fieldset style={fieldsetStyle}>
                    ...
                    <Box style={columnStyle}>
                        ...
                        <LoadingButton loading={isLoadingThematicHeatMap} variant="contained" onClick={() => onThematicHandle()}>Compare All Thematic Stocks</LoadingButton>
                    </Box>
                </fieldset>
                <fieldset style={fieldsetStyle}>
                    ...
                    <Box style={columnStyle}>
                        ...
                        <LoadingButton loading={isLoadingSectorHeatMap} variant="contained" onClick={() => onSectorHandle()}>Compare All Sector Stocks</LoadingButton>
                    </Box>
                </fieldset>
            </div>
            {
                isLoadingHeatMap ? <Box sx={{ height: "30rem", display: "flex", justifyContent: "center", alignItems: "center" }}><CircularProgress /> </Box> :
                    <Box>
                        {isSingleSheet &&
                            <Box>
                                <Typography sx={{ pl: 5, fontWeight: "bold", color: "blue" }}>{displayedOption}</Typography>
                                <Heatmap
